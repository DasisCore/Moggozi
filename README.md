...
- [6. 개발자](#6-개발자)
- [7. 기술적 고민](#7-기술적-고민)
  - [Front Trouble Shooting](#front-trouble-shooting)
  - [Back Trouble Shooting](#back-trouble-shooting)
- [8. 기타 자료](#8-기타-자료)
...
> 취미 공유 웹사이트 모꼬지는 여러 사람들의 다양한 취미를 차근차근 밟아 나갈 수 있는 서비스를 제공하는 웹사이트 입니다.
...
> 취미를 시작하고 싶지만 어떻게 시작할지 몰랐던 사람들에게 자신만 알고있기엔 아까웠던 취미 노하우를 마음껏 공유할 수 있는 공간, 그리하여 거창한 취미가 아니더라도 모두가 취미를 즐길 수 있도록 돕는 공간, 모꼬지가 지향하는 가치입니다.<br/>
...
> 이미지와 함께 자세한 설명은 [5.시연시나리오](https://drive.google.com/file/d/1Zw85PwF_qezx5kxNaeFc6XjYAOArsewl/view?usp=sharing) 에서 확인하세요!_ <sub>(글자를 누르시면 해당 페이지로 이동합니다)</sub>
...
> `README`에서는 주요 기능만을 설명합니다. 자세한 시나리오가 궁금하시다면 [모꼬지 시연시나리오]()를 클릭해주세요!
...
> 우리는 프로젝트를 진행하면서 다양한 문제들을 만났습니다. 그리고 프로젝트 완성 후에도 개선할 수 있는 부분들에 관해 고민하였습니다.
> 
